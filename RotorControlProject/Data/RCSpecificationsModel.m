...
% m     - Масса ротора
% S0    - Зазор
% It    - Ограничение по току
% L0    - Индуктивность ЭМП
% l1    - Растояние от верхнего РП до центра масс ротора
% l2    - Растояние от нижнего РП до центра масс ротора
% J     - Момент инерции относительно осей x и y
